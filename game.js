class Game{
    constructor(){
        ...
        this.castle = createSprite(8200,height/2+100);
        ...
        this.restart = createSprite(width/2+100,height/2+100);
        this.restart.visible = false;
        this.restartImg = loadImage("images/restart.png");
        this.restart.addImage(this.restartImg);
